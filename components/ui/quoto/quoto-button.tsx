...
export const QuotoButtonContent = ({ type, mode, args, className, form, onSuccess } : {
    ...
    return isDialog ? (
        ...
        <Sheet.Container className='px-8 py-4'>
            <div className='w-full flex justify-center items-center mb-4'><div className='border-2 w-1/4 rounded-full shadow-2xl' /></div>
            <Sheet.Header className='mb-4 gap-0 space-y-0'>
                <h1 className='text-left font-semibold tracking-tight'>{isCreating ? "Create a Quoto" : "Edit a Quoto"}</h1>
